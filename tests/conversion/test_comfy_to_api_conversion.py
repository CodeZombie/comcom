...
SIMPLE_SUBGRAPH_WORKFLOW_JSON_STRING = '''
{
...
def test_comfy_workflow_to_api_workflow_conversion():
    node_definitions = NodeDefinitions.model_validate_json(open('tests/data/object_info.json').read())
    comfy_workflow = ComfyWorkflow.model_validate_json(SIMPLE_SUBGRAPH_WORKFLOW_JSON_STRING)
