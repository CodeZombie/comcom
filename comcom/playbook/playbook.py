...
#             workflows[workflow_id] = Recipe.from_dict(workflow_id, workflow_dicts[workflow_id], {}, globals)
...
#     def get_workflow_by_path(self, workflow_path: str | List[str]) -> Recipe | None:
